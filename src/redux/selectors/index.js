...
export const coursesPublicState$ = (state) => state.coursesPublic
...
export const programingState$ = (state) => state.programing
...
export const assignmentsState$ = (state) => state.assignments
